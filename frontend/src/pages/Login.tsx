        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button
              type="button"
              onClick={() => googleLogin()}
              className="w-full flex items-center justify-center gap-4 px-6 py-4 rounded-full bg-[#f8dff3] text-[1.35rem] font-medium text-[#202124] shadow-sm hover:bg-[#f3d2ed] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#f8dff3] transition-all duration-200"
            >
              <svg className="h-10 w-10 shrink-0" aria-hidden="true" viewBox="0 0 48 48">
                <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.6 32.7 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C34 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.4-.4-3.5z" />
                <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16 18.9 12 24 12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C34 6.1 29.3 4 24 4 16.3 4 9.7 8.3 6.3 14.7z" />
                <path fill="#4CAF50" d="M24 44c5.1 0 9.7-2 13.2-5.2l-6.1-5.2C29.1 35.1 26.7 36 24 36c-5.1 0-9.4-3.3-11-7.8l-6.5 5C9.8 39.3 16.4 44 24 44z" />
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.4 5.5-6.2 6.8l6.1 5.2C39.6 36.5 44 30.8 44 24c0-1.2-.1-2.4-.4-3.5z" />
              </svg>
