...
function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-100 mt-16">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-4 gap-10 sm:gap-14 text-sm">
        ...
        {/* Legal Links */}
        <div>
          <p className="text-gray-900 font-bold text-base mb-4 tracking-wide">Legal</p>
          <ul className="flex flex-col gap-2.5 text-gray-600 font-semibold">
            <li>
